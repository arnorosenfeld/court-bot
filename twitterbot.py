...
class Settings:
	FeedUrl = "https://ecf.wyd.uscourts.gov/cgi-bin/rss_outside.pl"			# RSS feed to read and post tweets from.
...
class TwitterAuth:
	ConsumerKey = "HXuvyqABZOZqfjtrH30z122N8"
	ConsumerSecret = "LiKCHZMMBICdUfdZGn5qWrf7V378tQwNPsyDGVHwkMCZfWZo32"
	AccessToken = "905909585067745280-ZlEeBTjyjux2scmVGjxPZ1iiWbobh6c"
	AccessTokenSecret = "qyZtW5xhs3QmUqkn2mSGFA7A1kEjQ0MMFSmhzVuwLUSLP"
...
def SearchAndRetweet():
	...
	include_words = []	# Include tweets with these words.
